        ...
        <Card className="my-3 contenedor-card">
          ...
          <Card.Body>
            ...
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                Presion: {datosClima.main.pressure} Pa
              </ListGroup.Item>
              <ListGroup.Item>
                Viento: {datosClima.wind.speed} km/h
              </ListGroup.Item>
              <ListGroup.Item>
                Sensación Termica:{" "}
                {redondearTemperatura(datosClima.main.feels_like)}°C
              </ListGroup.Item>
              <ListGroup.Item>
                Temperatura Minima:{" "}
                {redondearTemperatura(datosClima.main.temp_min)}°C
              </ListGroup.Item>
              <ListGroup.Item>
                Temperatura Maxima:{" "}
                {redondearTemperatura(datosClima.main.temp_max)}°C
              </ListGroup.Item>
            </ListGroup>
          </Card.Body>
        </Card>
